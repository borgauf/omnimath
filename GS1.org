...
[murmurs of agreement] \\
@@html:<span class="fraktur">@@𝔘𝔴𝔢:@@html:</span>@@ Oh, and do you
remember the whole Euclid thing about the /transitivity of equality/?
[murmurs of affirmation] \\
@@html:<span class="fraktur">@@𝔘𝔯𝔰𝔲𝔩𝔞:@@html:</span>@@ Yeah, Herr
Adriansen, Danish minority from Schleswig. Cool accent. Made fun of
Frisians. He gave us that little talk about why old-school Euclidean
Geometry was so important. \\
@@html:<span class="fraktur">@@𝔘𝔴𝔢:@@html:</span>@@ Yes, because you
have to get used to the idea that math is built up from logical
deductions that in turn are based on axioms. \\
@@html:<span class="fraktur">@@𝔘𝔱𝔢:@@html:</span>@@ And he complained
bitterly about how math was being taught, how it was sliding into just
circus animals learning by conditioning. \\
@@html:<span class="fraktur">@@𝔘𝔴𝔢:@@html:</span>@@ The whole, /when
you see this, do this/ approach to math.[fn:2]
...
link on [[https://stackoverflow.com/questions/35950600/why-it-is-impossible-to-divide-integer-number-in-haskell][stackoverflow]] that talks about this[fn:5]. Getting
...
[fn:4] Check out anonymous or /lambda/ functions [[http://learnyouahaskell.com/higher-order-functions#lambdas][here]].

[fn:5] See [[https://stackoverflow.com/questions/35950600/why-it-is-impossible-to-divide-integer-number-in-haskell][Why it is impossible to divide Integer number in Haskell?]]

[fn:6] See [[http://learnyouahaskell.com/types-and-typeclasses#typeclasses-101][Typeclasses 101]] in /Learn You a Haskell.../.
